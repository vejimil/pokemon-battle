...
exports.BattleTextStream = exports.BattlePlayer = exports.BattleStream = void 0;
        ...
        if (this.replay) {
            if (type === 'update') {
                if (this.replay === 'spectator') {
                    const channelMessages = (0, battle_1.extractChannelMessages)(data, [0]);
                    this.push(channelMessages[0].join('\n'));
                }
                else {
                    const channelMessages = (0, battle_1.extractChannelMessages)(data, [-1]);
    ...
    _writeLine(type, message) {
        switch (type) {
            case 'start':
                ...
                if (this.debug)
                    options.debug = true;
                this.battle = new battle_1.Battle(options, this.dex);
                break;
            case 'player':
...
function getPlayerStreams(stream) {
    ...
    (async () => {
        for await (const chunk of stream) {
            ...
            switch (type) {
                case 'update':
                    const channelMessages = (0, battle_1.extractChannelMessages)(data, [-1, 0, 1, 2, 3, 4]);
