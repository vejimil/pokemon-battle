...
class Ability extends dex_data_1.BasicEffect {
    constructor(data) {
        ...
        (0, dex_data_1.assignMissingFields)(this, data);
    }
}
exports.Ability = Ability;
const EMPTY_ABILITY = utils_1.Utils.deepFreeze(new Ability({ id: '', name: '', exists: false }));
class DexAbilities {
    constructor(dex) {
    ...
    get(name = '') {
        if (name && typeof name !== 'string')
            return name;
        const id = (0, dex_data_1.toID)(name.trim());
