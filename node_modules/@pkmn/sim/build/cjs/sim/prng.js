...
exports.Gen5RNG = exports.SodiumRNG = exports.PRNG = void 0;
...
class SodiumRNG {
    ...
    setSeed(seed) {
        ...
        utils_1.Utils.bufWriteHex(seedBuf, seed[1].padEnd(64, '0'));
        this.seed = seedBuf;
    }
    getSeed() {
        return `sodium,${utils_1.Utils.bufReadHex(this.seed)}`;
    }
    next() {
        const zeroBuf = new Uint8Array(36);
        // tested to do the exact same thing as
        // sodium.randombytes_buf_deterministic(buf, this.seed);
        const buf = new ts_chacha20_1.Chacha20(this.seed, SodiumRNG.NONCE).encrypt(zeroBuf);
