                ...
                if (moveData.status) {
                    ...
                    if (moveData.status === 'slp' && target.volatiles['mustrecharge']) {
                        ...
                        if (target.setStatus(moveData.status, pokemon, move)) {
                            ...
                            this.battle.hint("In Gen 1, if a Pokémon that has just used Hyper Beam and has yet to recharge is targeted with a sleep inducing move, " +
