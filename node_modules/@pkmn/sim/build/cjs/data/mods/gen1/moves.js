        ...
        condition: {
            ...
            onTryHit(target, source, move) {
                if (move.category === 'Status') {
                    ...
                    if (move.status === 'psn' || move.status === 'tox' || (move.boosts && target !== source) ||
                ...
                if (target.volatiles['substitute']) {
                    ...
                    if (move.secondary?.volatileStatus === 'confusion') {
                        ...
                        if (secondary.chance === undefined || this.randomChance(Math.ceil(secondary.chance * 256 / 100) - 1, 256)) {
                            ...
                            this.hint("In Gen 1, moves that inflict confusion as a secondary effect can confuse targets with a Substitute, " +
