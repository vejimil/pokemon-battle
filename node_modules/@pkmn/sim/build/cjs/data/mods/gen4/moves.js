...
exports.Moves = {
    ...
    fling: {
        ...
        onPrepareHit(target, source, move) {
            if (source.ignoringItem(true))
                return false;
            if (source.hasAbility('multitype'))
                return false;
    ...
    metronome: {
        ...
        onHit(pokemon) {
            const moves = this.dex.moves.all().filter(move => (move.flags['metronome'] && !pokemon.moves.includes(move.id) &&
    ...
    switcheroo: {
        inherit: true,
        onTryHit(target, source, move) {
            if (target.itemKnockedOff || source.itemKnockedOff)
                return false;
