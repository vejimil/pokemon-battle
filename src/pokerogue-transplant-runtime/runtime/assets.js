...
export function preloadUiAssets(scene) {
  ...
  if (!textures.exists(UI_ASSETS.effectBattleStats.key)) load.multiatlas(UI_ASSETS.effectBattleStats.key, UI_ASSETS.effectBattleStats.json, './assets/pokerogue/effects/');
